...
class AmbienteRiscoController extends Controller
{
    ...
    public function post(Request $request)
    {
        ...
        $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/ppra-ambiente-riscos/");
        ...
        if ($result['status'] == 'true') {
            ...
            $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/ppra-ambiente-risco-medidas/");
    ...
    public function destroy(Request $request)
    {
        ...
        $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/ppra-ambiente-risco-medidas/" . $request->idAmbienteRiscoMedida);
        ...
        $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/ppra-ambiente-riscos/" . $request->idAmbienteRisco);
    ...
    public function historico(Request $request) {
        ...
        $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/ppra-ambiente-risco-medidas/listaPorEmpresaContratoRisco/");
