...
class PPRAController extends Controller
{
    ...
    {
        return view('ppra.index', compact('ppras'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/ppras");
    ...
    public function postPlanoAcao($ppra, Request $request)
    {
        ...
        $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/ppra-plano-acoes");
    ...
    {
        $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/ppra-plano-acoes/" . $id);
    ...
    {
        $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/ppras/" . $id);
    ...
    public function ultimo(Request $request) {
        $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/ppras/pegaUltimoPpraPorEmpresaEmpresaContrato/");
    ...
    public function capa($ppra){
        $json = file_get_contents("http://200.98.201.236/ServicoSIGSSO/rest/ppra-capas/buscaPpraCapaPorIdPpra/" . $ppra);
        
        return $json;
    }

    public function exames($ppra){
        $json = file_get_contents("http://200.98.201.236/ServicoSIGSSO/rest/exames/listaPorIdPpra/" . $ppra);
        
        return $json;
    }

    public function listHistoricoExames($ppra) {
        $json = file_get_contents("http://200.98.201.236/ServicoSIGSSO/rest/ppra-exames-historico/listaPorIdPpra/" . $ppra);
    ...
    public function historicoExame($ppra, Request $request) {
        ...
        $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/ppra-exames-historico/");
    ...
    public function postCapa($ppra, Request $request) {
        ...
        $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/ppra-capas/");
    ...
    public function contratoPeriodo(Request $request) {
        ...
        $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/ppras/listaPpraPorEmpresaEmpresaContratoPeriodoCongelado/");
