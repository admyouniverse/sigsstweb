...
class AgenteCausadorDeDoencaProfissionalController extends Controller
{
    /**
    ...
    {
        return view('tabelas.agente-causador-de-doenca-profissional');
    }
    ...
    public function store(Request $request)
    {
        ...
        $array = [];
        $array['idAgenteCausadorDoencaProfissional'] = 0;
   ...
   //   return $json;
        $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/agentesCausadoresDoencaProf");
    ...
    {
        $array = [];
        $array['idAgenteCausadorDoencaProfissional'] = intval($id);
        $array['descricao'] = $request->descricao;
        $array['codigoAgente'] = $request->codigo;
        $array['observacao'] = $request->observacao;
        $array['usuario'] = 1;
   ...
   //   return $json;
    ...
    public function destroy($id)
    {
     ...
     $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/agentesCausadoresDoencaProf/" . $id);
