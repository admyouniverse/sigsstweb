...
class FonteGeradoraController extends Controller
{
    /**
    ...
    {
        return view('tabelas.riscos.fonte-geradora');
    }
    ...
    public function store(Request $request)
    {
        ...
        $array = [];
        $array['idFonteGeradora'] = 0;
        $array['descricao'] = $request->descricao;
        $array['grupoFonteGeradora'] = $request->grupo;
        $array['usuario'] = 1;
