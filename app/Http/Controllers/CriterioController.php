...
class CriterioController extends Controller
{
    ...
    {
        $json = file_get_contents('http://200.98.201.236/ServicoSIGSSO/rest/criterios');
        return $json;
    }
    ...
    {
        return view('matriz.criterio.index');
    }
