...
class ExamesComplementares extends Controller
{
    ...
    */
    ...
    public function ultimo ($funcionario) {
        ...
        $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/solicitacoes-exames/listaUltimaSolicitacaoPorEmpresaFuncionario/");
    ...
    */
    public function list(Request $request)
    {
        ...
        $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/exames-complementares-exames/listaPorIdEmpresaIdEmpresaFuncionarioDataExameIniFim/");
    ...
    */
    public function store(Request $request)
    {
        ...
        if(empty($json)) {
            ...
            $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/exames-complementares/");
    ...
    */
    ...
    {
        $ch = curl_init("http://200.98.201.236/ServicoSIGSSO/rest/exames-complementares-exames/" . $id);
