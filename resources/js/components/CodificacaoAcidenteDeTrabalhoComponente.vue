...
<section class="content">
    ...
    <div class="row" style="margin-bottom: 15px; margin-top: 10px">
        <div class="col-md-6">
            ...
            <download-excel v-if="montou" class="btn btn-sm btn-secondary" :data="this.codificacoes" name="codificacoes.xls">
    ...
    <div v-if="montou" class="box box-info">
        ...
        <div class="box-body table-responsive">
            <table class="table table-hover table-striped" id="tabelaListagem">
                ...
                <tbody>
                    <tr v-for="codificacao in codificacoes">
                        <td style="vertical-align: middle" width="80px"><b>{{ codificacao.codigoAcidente }}</b></td>
                        <td style="text-align:justify; vertical-align: middle">{{ codificacao.descricao }}</td>
                        <td width="100px" style="vertical-align: middle" class="text-center">
                            <button type="button" @click="remover(codificacao)" class="btn btn-sm btn-outline-danger"><i class="fa fa-trash"></i>
                            </button>
                            <button type="button" @click="preencher(codificacao)" class="btn btn-sm btn-outline-primary"><i class="fas fa-pencil-alt"></i>
                            </button>
                        </td>
                    </tr>
                </tbody>
    ...
    <b-modal size="sm" :no-close-on-backdrop="true" centered :hide-header="true" :hide-footer="true" :no-close-on-esc="true" ref="modalCerteza" id="modalCerteza">
        <div class="row">
            <div class="col-md-12 text-center">
                <h3>Tem certeza que deseja excluir esta Codificação de Acidente de Trabalho? </h3>
            </div>
        </div>
