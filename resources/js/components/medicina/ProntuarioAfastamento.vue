...
export default {
    ...
    methods: {
        ...
        salvar() {
			...
			axios.post('/prontuario-medico/afastamento', {
				...
				axios.get('http://200.98.201.236/ServicoSIGSSO/rest/prontuario-afastamentos/listaPorIdProntuario/' + that.prontuario.idProntuario).then(function (response) {
    ...
    mounted() {
        var that = this;
        axios.get('http://200.98.201.236/ServicoSIGSSO/rest/prontuario-afastamentos/listaPorIdProntuario/' + this.prontuario.idProntuario).then(function (response) {
			that.afastamentos = response.data;
        });
