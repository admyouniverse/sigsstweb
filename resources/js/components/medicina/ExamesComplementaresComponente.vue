...
export default {
    ...
    methods: {
        ...
        cancelarNovo: function () {
            ...
            axios.get(process.env.MIX_APP_API + 'ServicoSIGSSO/rest/exames-complementares-exames/listaPorIdEmpresaFuncionario/' + this.funcionario.idEmpresaFuncionario).then(function (response) {
        ...
        abrir(funcionario) {
            ...
            axios.get(process.env.MIX_APP_API + 'ServicoSIGSSO/rest/exames-complementares-exames/listaPorIdEmpresaFuncionario/' + funcionario.idEmpresaFuncionario).then(function (response) {
                that.complementares = response.data;
                // console.log(that.complementares);
                that.$refs.modalComplementar.show();
            });
        ...
        semSolicitacao() {
            var that = this;
            axios.get(process.env.MIX_APP_API + 'ServicoSIGSSO/rest/exames/').then(function(response) {
        ...
        incluir(solicitacao) {
            ...
            axios.get(process.env.MIX_APP_API + 'ServicoSIGSSO/rest/exames/' + this.solicitacao.idExame).then(function(response) {
                that.exame = response.data;
                that.complementar.exame = response.data;
           
                axios.get(process.env.MIX_APP_API + 'ServicoSIGSSO/rest/exames-complementares-exames/listaPorIdExame/' + that.solicitacao.idExame).then(function (response) {
        ...
        salvarNovo(evt) {
            ...
            axios.post('/exames-complementares', {
                ...
                axios.get(process.env.MIX_APP_API + 'ServicoSIGSSO/rest/exames-complementares-exames/listaPorIdExame/' + that.complementar.exame.idExame).then(function (response) {
                    ...
                    axios.get(process.env.MIX_APP_API + 'ServicoSIGSSO/rest/exames-complementares-exames/listaPorIdEmpresaFuncionario/' + that.funcionario.idEmpresaFuncionario).then(function (response) {
                        that.complementares = response.data;
