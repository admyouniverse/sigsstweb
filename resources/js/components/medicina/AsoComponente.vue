...
export default {
    ...
    methods: {
                    ...
                    .then(function(response) {
                        setTimeout(function() {
                            if (response.data != "") {
                                ...
                                axios
                                    .get(
                                        "http://200.98.201.236:8080/ServicoSIGSSO/rest/pcmso-historico-revisoes/listaPorIdPcmso/" +
        ...
        listaTemporarios: function() {
            ...
            axios
                .get(
                    "http://200.98.201.236:8080/ServicoSIGSSO/rest/empresaFuncionarios/listaFuncionariosTemporariosPorIdEmpresa/" +
    ...
    mounted() {
        ...
        axios
            .get(
                "http://200.98.201.236:8080/ServicoSIGSSO/rest/empresaFuncionarios/listaFuncionariosAtivosPorIdEmpresa/" +
                    that.empresa.idEmpresa
            )
            .then(function(response) {
