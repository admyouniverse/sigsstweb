...
export default {
    ...
    methods: {
        ...
        modalPeriodico: function (tipo) {
            ...
            if (tipo == 'RETORNO_TRABALHO') {
                ...
                axios.get('http://200.98.201.236/ServicoSIGSSO/rest/empresaFuncionarios/listaPorIdEmpresa/' + this.empresa.idEmpresa).then(function (response) {
                    that.funcionarios = response.data;
                    that.$refs.modalPeriodico.show();
                    that.carregando = false;
                });
        ...
        buscarPessoasContratos: function (callback) {
            var that = this;
            axios.get('http://200.98.201.236/ServicoSIGSSO/rest/pessoas/semVinculoEmpregaticioPorIdEmpresa/' + this.empresa.idEmpresa).then(function (response) {
        ...
        buscaCpfPeriodico: function () {
            ...
            if (verif.length > 0 && this.dataDiff(verif[0].data, this.solicitacao.data) <= 30) {
                ...
                if (filtrada.length == 0) {
                    ...
                    axios.get('http://200.98.201.236/ServicoSIGSSO/rest/pessoas/semVinculoEmpregaticioPorIdEmpresa/' + that.empresa.idEmpresa).then(function (response) {
            ...
            if (verif.length > 0) {
                ...
                if (filtrada.length == 0) {
                    ...
                    if (this.solicitacao.tipoAtestado == 'ADMISSIONAL') {
                        ...
                        axios.get('http://200.98.201.236/ServicoSIGSSO/rest/pessoas/comVinculoEmpregaticioPorIdEmpresa/' + that.empresa.idEmpresa).then(function (response) {
                            var empregados = response.data;
    ...
    mounted() {
        ...
        axios.get('http://200.98.201.236/ServicoSIGSSO/rest/solicitacoes').then(function (response) {
