                    ...
                    <b-card-text>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a class="btn pull-right btn-success" target="_blank" v-if="ppra.idPpra && ppra.caminhoPdf" :href="'http://200.98.201.236:8081/' + ppra.caminhoPdf"><i class="fas fa-eye"></i> Visualizar PDF</a>
