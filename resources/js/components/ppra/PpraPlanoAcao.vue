            ...
            <table class="table">
                <tbody>
                    ...
                    <tr v-for="(acao, key) in acoes">
                        ...
                        <td class="text-center"><a><img src="/img/pdf.png" width="21px"></a></td>
                        <td>
                            <button class="btn btn-sm btn-outline-primary" @click="editar(acao)"><i class="fas fa-pencil-alt"></i></button>
                            <button class="btn btn-sm btn-outline-danger" v-if="key+1 > 2" @click="remover(acao)"><i class="fa fa-trash"></i></button>
                        </td>
                    </tr>
                </tbody>
            </table>
