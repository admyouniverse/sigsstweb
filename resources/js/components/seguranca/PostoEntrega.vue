...
export default {
        ...
        salvar() {
            ...
            axios.post('/posto-entrega', {
                ...
                if (response.data.status == "true") {
                    axios.get('http://200.98.201.236/ServicoSIGSSO/rest/posto-entrega/listaPorIdEmpresa/' + that.empresa.idEmpresa).then(function (response) {
    ...
    mounted() {
        var that = this;
        axios.get('http://200.98.201.236/ServicoSIGSSO/rest/posto-entrega/listaPorIdEmpresa/' + this.empresa.idEmpresa).then(function (response) {
            that.postos = response.data;
            that.carregando = false;
        });
