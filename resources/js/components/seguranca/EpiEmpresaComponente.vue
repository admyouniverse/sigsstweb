...
export default {
    ...
    methods: {
        ...
        editarGrade: function (grade) {
            ...
            axios.get('http://200.98.201.236:8080/ServicoSIGSSO/rest/cadastro-epi-cas/listaCadastroEpiCaPorIdCadastroEpi/' + this.epi.idCadastroEpi).then(function (response) {
        ...
        removerGrade: function (grade) {
            ...
            axios.get('/cadastro-epi/grade/' + grade.idGradeEmpresaEpi).then(function (response) {
                if (response.data.status == 'true') {
                    axios.get('http://200.98.201.236:8080/ServicoSIGSSO/rest/grade-empresa-epis/listaPorIdCadastroEpi/' + that.epi.idCadastroEpi).then(function (response) {
        ...
        preencher: function (epi) {
            ...
            axios.get('http://200.98.201.236:8080/ServicoSIGSSO/rest/grade-empresa-epis/listaPorIdCadastroEpi/' + epi.idCadastroEpi).then(function (response) {
                that.grades = response.data;
    ...
    mounted() {
        ...
        axios.get('http://200.98.201.236:8080/ServicoSIGSSO/rest/tamanhos').then(function (response) {
