    ...
    methods: {
        ...
        certeza: function () {
            ...
            axios.get('/posto-entrega/entrega/remover/' + this.entrega.idEntregaEpi).then((response) => {
                axios.get('http://172.18.0.6:8080/ServicoSIGSSO/rest/entrega-epis/').then(function (response) {
        ...
        visualizar: function (entrega) {
            ...
            axios.get('http://172.18.0.6:8080/ServicoSIGSSO/rest/entrega-epi-itens/listaPorIdEntregaEpi/' + entrega.idEntregaEpi).then(function (response) {
                ...
                that.entregaItens.map((entregaItem, i) => {
                    ...
                    axios.get('http://172.18.0.6:8080/ServicoSIGSSO/rest/entrega-epi-itens-historico/listaPorIdEntregaEpiItens/' + entregaItem.idEntregaEpiItens).then(function (response) {
                        ...
                        if (rowLen == i + 1) {
                            ...
                            axios.get('http://172.18.0.6:8080/ServicoSIGSSO/rest/ambiente-cadastro-epis/listaPorIdEmpresaFuncionario/' + entrega.empresaFuncionario.idEmpresaFuncionario).then(function (response) {
                ...
                if (this.entregaItens.length == 1) {
                    ...
                    axios.get('/posto-entrega/entrega/remover-item/' + this.entregaItens[index].idEntregaEpiItens).then((response) => {
                        if (response.data.status == "true") {
                            axios.get('http://172.18.0.6:8080/ServicoSIGSSO/rest/ambiente-cadastro-epis/listaPorIdEmpresaFuncionario/' + that.entrega.empresaFuncionario.idEmpresaFuncionario).then(function (response) {
                                that.liberados = response.data;
        ...
        selecionar: function (funcionario) {
            ...
            axios.get('http://172.18.0.6:8080/ServicoSIGSSO/rest/ambiente-cadastro-epis/listaPorIdEmpresaFuncionario/' + funcionario.idEmpresaFuncionario).then(function (response) {
                that.liberados = response.data;
