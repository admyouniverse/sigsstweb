...
export default {
    ...
    methods: {
        ...
        listaItens() {
            ...
            axios.get('http://200.98.201.236:8080/ServicoSIGSSO/rest/grade-empresa-epis/listaPorIdEmpresa/' + this.empresa.idEmpresa).then(function (response) {
        ...
        salvar(evt) {
            ...
            axios.post("/posto-entrega/" + this.posto.idPostoEntrega + "/item/multiplos", {
                ...
                axios.get('http://200.98.201.236:8080/ServicoSIGSSO/rest/entrada-epis/listaPorIdPostoEntrega/' + that.posto.idPostoEntrega).then(function (response) {
    ...
    mounted() {
        ...
        axios.get('http://200.98.201.236:8080/ServicoSIGSSO/rest/entrada-epis/listaPorIdPostoEntrega/' + this.posto.idPostoEntrega).then(function (response) {
            that.entradas = response.data;
        });
