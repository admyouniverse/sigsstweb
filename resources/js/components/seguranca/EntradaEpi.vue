...
export default {
    ...
    methods: {
        ...
        salvar() {
            ...
            axios.post("/posto-entrega/" + this.posto.idPostoEntrega +"/item/" + this.item.idEstoque, {
                ...
                axios.get('http://172.18.0.6:8080/ServicoSIGSSO/rest/entrada-epis/listaPorIdEstoque/' + that.item.idEstoque).then(function(response) {
    ...
    mounted() {
        ...
        axios.get('http://172.18.0.6:8080/ServicoSIGSSO/rest/entrada-epis/listaPorIdEstoque/' + this.item.idEstoque).then(function(response) {
            that.entradas = response.data;
        });
    }
}
