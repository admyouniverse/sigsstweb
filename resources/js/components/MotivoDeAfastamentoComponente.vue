...
<section class="content">
    ...
    <div class="row" style="margin-bottom: 15px; margin-top: 10px">
        <div class="col-md-6">
            ...
            <download-excel v-if="montou" class="btn btn-sm btn-secondary" :data="this.motivos" name="motivos.xls">
            ...
            <table class="table table-hover table-striped" id="tabelaListagem">
                ...
                <tbody>
                    <tr v-for="motivo in motivos">
                        <td style="vertical-align: middle" width="80px"><b>{{ motivo.codigoMotivo }}</b></td>
                        <td style="text-align:justify; vertical-align: middle">{{ motivo.descricao }}</td>
                        <td class="text-center capitalize">{{motivo.prontuario}}</td>
                        <td width="100px" style="vertical-align: middle" class="text-center">
                            <button type="button" @click="remover(motivo)" class="btn btn-sm btn-outline-danger"><i class="fa fa-trash"></i>
                            </button>
                            <button type="button" @click="preencher(motivo)" class="btn btn-sm btn-outline-primary"><i class="fas fa-pencil-alt"></i>
                            </button>
                        </td>
                    </tr>
                </tbody>
    ...
    <b-modal size="xl" centered :no-close-on-backdrop="true" @ok="ok" :hide-header-close="true" :no-close-on-esc="true" @cancel="fechar()" title="Detalhes do motivo" ok-title="Salvar" cancel-title="Cancelar" ref="myModal" id="modal1">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label>Código eSocial</label>
                    <input type="text" v-mask="'#########'" class="form-control" v-model="codigo">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label>Listar no prontuário afastamento</label>
                    <select v-model="prontuario" class="form-control">
    ...
    <b-modal size="sm" :no-close-on-backdrop="true" centered :hide-header="true" :hide-footer="true" :no-close-on-esc="true" ref="modalCerteza" id="modalCerteza">
        <div class="row">
            <div class="col-md-12 text-center">
                <h3>Tem certeza que deseja excluir este motivo? </h3>
            </div>
        </div>
